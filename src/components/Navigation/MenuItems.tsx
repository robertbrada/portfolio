...
const sharedClasses =
  'my-1 py-0.5 pl-2 pr-[0.95rem] w-fit rounded-xs text-left text-sm transition-all hover:font-medium duration-200 font-normal';
